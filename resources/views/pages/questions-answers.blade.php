...
@section('page-title', 'Questions & Answers')
...
@section('content-header', 'Questions & Answers (Partnership with parents)')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn btn-sm btn-info" href="{{route('questions-answer-create')}}">Add Q/A</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach($news as $link)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('questions-answer-edit',$link['id']) }}" class="btn btn-xs btn-info">
                                            <i class="far fa-edit mr-1"></i>Edit</a>
                                        <a href="{{ route('questions-answer-delete', $link['id']) }}" class="btn btn-xs btn-danger"><i class="far fa-trash-alt mr-1"></i>Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
